...
import com.example.personalfinances.categories.AddCategoryActivity
import com.example.personalfinances.categories.CategoriesAdapter
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
            when (result.resultCode) {
                AppCompatActivity.RESULT_OK -> {
                    ...
                    Toast.makeText(requireActivity(), "A new category is added", Toast.LENGTH_SHORT)
                        .show()
                }
